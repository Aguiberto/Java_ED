...
public class TesteLista{
    ...
    public static void main(String [] args) throws InterruptedException {
        ...
        ArrayListaMestra ListaNegra = new ArrayListaMestra(10);
        ...
        while(true){
            ...
            if(opcaoLista == 1){
                ...
                Object anteior = ListaNegra.before(indice);
                ...
                System.out.println("O valor anterior: " + ListaNegra.after(indice));
                ...
                System.out.println("Você selecionou : inserir ANTES");

                System.out.print("Informe um índice para inserir um valor antes: ");
                int indice = scanner.nextInt();

                System.out.print("Valor a ser inserido antes: ");
                int valor = scanner.nextInt();
                ...
                System.out.println("Você selecionou : inserir DEPOIS");
